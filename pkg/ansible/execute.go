...
func NewDefaultExecute(options ...execute.ExecuteOptions) *DefaultExecute {
...
func WithWrite(w io.Writer) execute.ExecuteOptions {
...
func WithWriteError(w io.Writer) execute.ExecuteOptions {
	return func(e execute.Executor) {
...
func WithCmdRunDir(cmdRunDir string) execute.ExecuteOptions {
	return func(e execute.Executor) {
...
func WithShowDuration() execute.ExecuteOptions {
	return func(e execute.Executor) {
...
func WithTransformers(trans ...results.TransformerFunc) execute.ExecuteOptions {
	return func(e execute.Executor) {
...
func WithEnvVar(key, value string) execute.ExecuteOptions {
	return func(e execute.Executor) {
...
func (e *DefaultExecute) Execute(ctx context.Context, command []string, resultsFunc stdoutcallback.StdoutCallbackResultsFunc, options ...execute.ExecuteOptions) error {
